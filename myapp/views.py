...
def add_temperature(request):
    if request.method == 'POST':
        ...
        return render(request, 'add_temperature.html')#--測試3
        #return HttpResponse("請使用POST方法送出資料")--測試2

    #return HttpResponse("Adding temperature via API")--測試1
